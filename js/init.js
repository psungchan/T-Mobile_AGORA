...
{
    var value = parseInt(document.getElementById('likes-button').value, 10);
    value = isNaN(value) ? 0 : value;
    value++;
    document.getElementById('likes-button').value = value;
  //  var element = document.getElementById("likes-button");
